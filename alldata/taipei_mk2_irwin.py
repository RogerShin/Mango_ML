...
def irwin_anal_mk2_data(df_taipei_mk2, output_dir='assets'):
    ...
    plt.title('平均價(元/公斤)')
    box_plot = os.path.join(output_dir, 'irwin_box_plot_2.png')
    ...
    plt.ylabel('密度')
    plt.xlabel('平均價(元/公斤)')
    distribution_plot= os.path.join(output_dir, 'irwin_distribution_plot_2.png')
...
# 準備進行SARIMA建模的資料
def irwin_time_series2(df_taipei_mk2, output_dir='assets'):
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
   ...
   # 目標值
    ...
    acf_pacf_plot = os.path.join(output_dir, 'irwin_acf_pacf_plot_2.png')
    plt.tight_layout()
    ...
    sarima_model_plot = os.path.join(output_dir, 'irwin_sarima_model_analysis_2.png')
    ...
    combined_train_test_plot = os.path.join(output_dir, 'irwin_train_test_plot_2.png')
    ...
    residuals_plot = os.path.join(output_dir, 'irwin_residuals_qq_plot_2.png')
    plt.tight_layout()
...
# df_taipei_mk2 = taipei_mk2(market)
# print(df_taipei_mk2)
# print("=" * 100)
