...
def anal_mk1_data(df_taipei_mk2, output_dir='images'):
...
# 準備進行SARIMA建模的資料
def time_series(df_taipei_mk2, output_dir='images'):
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
...
acf_pacf_plot, Training_MSE, Training_RMSE, Training_MAE, Testing_MSE, Testing_RMSE, Testing_MAE, sarima_model_plot, combined_train_test_plot, residuals_plot = time_series(df_taipei_mk2, output_dir='images')
print("=" * 100)
print(Training_MSE)
print(Training_RMSE)
print(Training_MAE)
