...
# 清整後的 "台北一" 市場資料
def chiinhwang_taipei_mk1(market):
...
def chiinhwang_anal_mk1_data(df_taipei_mk1, output_dir='assets'):
    ...
    plt.title('平均價(元/公斤)')
    box_plot = os.path.join(output_dir, 'chiinhwang_box_plot_1.png')
    ...
    plt.ylabel('密度')
    plt.xlabel('平均價(元/公斤)')
    distribution_plot= os.path.join(output_dir, 'chiinhwang_distribution_plot_1.png')
...
def chiinhwang_time_series1(df_taipei_mk1, output_dir='assets'):
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
   ...
   # 目標值
    ...
    acf_pacf_plot = os.path.join(output_dir, 'chiinhwang_acf_pacf_plot_1.png')
    plt.tight_layout()
    ...
    plt.legend()
    sarima_model_plot = os.path.join(output_dir, 'chiinhwang_sarima_model_analysis_1.png')
    ...
    plt.tight_layout()
    combined_train_test_plot = os.path.join(output_dir, 'chiinhwang_train_test_plot_1.png')
    ...
    plt.title('Q-Q Plot')
    residuals_plot = os.path.join(output_dir, 'chiinhwang_residuals_qq_plot_1.png')
    plt.tight_layout()
